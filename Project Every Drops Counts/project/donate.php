										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select id="hospital" name="hospital" class="form-control">
													...
													<option value="1213145611">Grecian Super
														speciality Hospital</option>
													<option value="1213145612">IVY Hospital</option>
													<option value="1213145613">Pgimer Hospital</option>
													<option value="1213145614">SGHS Superspeciality
														Hospital</option>
													<option value="1213145615">Max Super
														Speciality Hospital (Mohali)</option>
													<option value="1213145616">Cosmo Hospital</option>
												</select>
											</div>
										</div>
										<!-- Select Basic -->
